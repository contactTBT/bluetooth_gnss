...
import static com.dnablast.bluetooth_gnss.MainActivity.MAIN_ACTIVITY_CLASSNAME;
import static com.dnablast.bluetooth_gnss.MainActivity.get_bd_map;
import static com.dnablast.libbluetooth_gnss_service.Log.LogObserver;
import static com.dnablast.libbluetooth_gnss_service.Log.d;
import static com.dnablast.libbluetooth_gnss_service.Log.getStackTraceString;
import static com.dnablast.libbluetooth_gnss_service.Log.m_log_operations_fos;
import static com.dnablast.libbluetooth_gnss_service.gnss_sentence_parser.fromHexString;
...
import com.dnablast.bluetooth_gnss.R;
...
public class bluetooth_gnss_service extends Service implements rfcomm_conn_callbacks, usb_conn_callbacks, gnss_sentence_parser.gnss_parser_callbacks, ntrip_conn_callbacks, LogObserver {
    ...
    public static final String POSITION_UPDATE_INTENT_ACTION = "com.dnablast.libbluetooth_gnss_service.POSITION_UPDATE";
    public static final String PARSED_NMEA_UPDATE_INTENT_ACTION = "com.dnablast.libbluetooth_gnss_service.PARSED_NMEA_UPDATE";
    ...
    private Notification getMyActivityNotification(String title, String text, String ticker){
        ...
        NotificationManager mNotificationManager =
                (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
         {
            ...
            channel.setDescription("RTK Correction Status");
...
*/
                ...
                m_handler.post(
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                updateNotification("RTK Correction - Not active...", "Deactivated", "");
                            }
                        }
                );
                ...
                m_handler.post(
                        new Runnable() {
                            ...
                            public void run() {
                                ...
                                updateNotification("RTK Correction - Active...", "Connected to: "+get_connected_device_alias(), "");
                            }
                        }
                );
    ...
    public void onDestroy() {
        ...
        stop_auto_reconnect_thread();
        toast("Stopped RTK Correction Service...");
    }
}
